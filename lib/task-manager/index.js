...
function _run(key, callback) {
    ...
    try {
        ...
        try {
            ...
            throw new Error("Unable to load extraction module: " + error.message);
        };
        /* Transformations */
        try {
            ...
            throw new Error("Unable to load transformation modules: " + error.message);
        };
        /* Load */
        try {
            load = this.loads[L.Name].call(L);
        } catch (error) {
            throw new Error("Unable to load load module: " + error.message);
        };
    } catch (error) {
    ...
    (function doEtlTask(self) {
        ...
        try {
            ...
            throw new Error("Task : " + key + " : Error extracting data: " + error.message);
        };
                    ...
                    (function transformItem(j) {
                        if (item && j < transformations.length) {
                            ...
                            t.transform.call(t, item)
                                ...
                                .catch(function(msg) {
                                    throw new Error("Task : " + key + " : Error transforming data: " + msg);
                                });
